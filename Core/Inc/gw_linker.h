...
extern void * _OVERLAY_CUPCAKE_LOAD_START[];
extern uint8_t _OVERLAY_CUPCAKE_SIZE;
extern void * _OVERLAY_CUPCAKE_BSS_START[];
extern uint8_t _OVERLAY_CUPCAKE_BSS_SIZE;
